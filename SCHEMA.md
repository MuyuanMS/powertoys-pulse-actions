...
Newly evaluated or rewritten PR findings must pass the private
[upstream grounding contract](./.github/skills/powertoys-pr-review/references/finding-grounding.md)
before publication. Origin, counterevidence, exact source excerpts and final-body
hashes stay in the session dossier, not this public feed. The strict processed-PR
validator checks that dossier with `-RequireFindingGrounding -GroundingPath`.
This is a producer gate, not a new public schema field or a blanket invalidation
of legacy data. Source matching cannot replace substantive defect validation.
